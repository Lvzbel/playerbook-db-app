...
const buildPhaseContainer = (report, playbook) => {
  let attack_patterns = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["getTypeFromReport"])("attack-pattern", report, playbook);
  let campaign = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["getTypeFromReport"])("campaign", report, playbook)[0];

  let recon = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("recon", attack_patterns);
  let weap = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("weaponization", attack_patterns);
  let delivery = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("delivery", attack_patterns);
  let exploit = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("exploitation", attack_patterns);
  let install = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("installation", attack_patterns);
  let command = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("command-and-control", attack_patterns);
  let objective = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["filterByKCP"])("act-on-objectives", attack_patterns);
...
__webpack_require__(/*! ./mystyles.scss */ "./public/src/mystyles.scss");
  ...
  static addReportLinks(playbook) {
    ...
    reports.forEach(r => {
      ...
      if (labels.includes("intrusion-set")) {
        // Check this variable
        let current_intrusion_set = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["getTypeFromReport"])(
          "intrusion-set",
          r,
          playbook
        )[0].name;
      } else {
        let campaign = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["getTypeFromReport"])("campaign", r, playbook);
    ...
    parsed_reports.forEach(r => {
      ...
      li.addEventListener("click", event => {
        ...
        const report = Object(_utilities__WEBPACK_IMPORTED_MODULE_0__["findById"])(_fetch__WEBPACK_IMPORTED_MODULE_2__["currentPlaybook"], reportId);
